const data = [
    ...
    },
    {
        ...
        max_speed: "305km/h",
        acceleration: "3.6s",
        description: "The Urus is Lamborghini's first Super SUV, merging the soul of a super sports car with the functionality of an SUV. Equipped with a 4.0-liter twin-turbo V8 engine, it delivers exceptional performance, luxury, and versatility. The Urus is designed to provide an exhilarating driving experience on any terrain.",
        price: "$218,000"
    },
    {
        brand: "Lamborghini",
    ...
    },
    {
        ...
        max_speed: "325km/h",
        acceleration: "3.4s",
        description: "The Gallardo LP 570-4 Superleggera is a lightweight, high-performance variant of the Gallardo. It features a 5.2-liter V10 engine, advanced aerodynamics, and extensive use of carbon fiber, making it one of the most agile and responsive Lamborghinis ever built.",
        price: "$237,600"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "342km/h",
        acceleration: "3.2s",
        description: "The Murciélago LP 670-4 SV (SuperVeloce) is the ultimate version of the Murciélago, boasting increased power, reduced weight, and enhanced aerodynamics. With its 6.5-liter V12 engine and aggressive design, it delivers a raw and exhilarating driving experience.",
        price: "$450,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "355km/h",
        acceleration: "2.8s",
        description: "The Lamborghini Veneno is a limited-production hypercar built to celebrate Lamborghini's 50th anniversary. With its radical design, extreme performance, and a 6.5-liter V12 engine, the Veneno is one of the most exclusive and sought-after Lamborghinis ever made.",
        price: "$4,500,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "350km/h",
        acceleration: "2.8s",
        description: "The Centenario was created to honor the 100th birthday of Lamborghini's founder, Ferruccio Lamborghini. It features advanced aerodynamics, cutting-edge technology, and a powerful V12 engine. The Centenario is a true collector's item, with only 40 units produced.",
        price: "$2,000,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "340km/h",
        acceleration: "3.4s",
        description: "The Lamborghini Reventón is an ultra-exclusive model inspired by the fastest airplanes. With its stealth-fighter design, carbon fiber body, and 6.5-liter V12 engine, the Reventón delivers exceptional performance and an unmatched visual presence.",
        price: "$2,000,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "335km/h",
        acceleration: "3.9s",
        description: "The Diablo SV (SuperVeloce) is a high-performance variant of the iconic Diablo. With a 5.7-liter V12 engine and rear-wheel drive, the Diablo SV offers an exhilarating driving experience with distinctive styling and raw power.",
        price: "$300,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "355km/h",
        acceleration: "2.8s",
        description: "The Countach LPI 800-4 is a modern interpretation of the classic Countach, celebrating its legacy with advanced hybrid technology and a powerful V12 engine. With its iconic design and cutting-edge performance, the Countach LPI 800-4 bridges the past and future of Lamborghini.",
        price: "$2,640,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "310km/h",
        acceleration: "3.0s",
        description: "The Huracán STO (Super Trofeo Omologata) is a track-focused variant of the Huracán, designed for maximum performance and agility. With a naturally aspirated V10 engine and advanced aerodynamics, the Huracán STO delivers an unparalleled driving experience on both road and track.",
        price: "$327,838"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "N/A",
        acceleration: "N/A",
        description: "The Essenza SCV12 is a track-only hypercar with the most powerful V12 engine ever developed by Lamborghini. It features advanced aerodynamics and lightweight construction, designed exclusively for high-performance driving on the track.",
        price: "$2,700,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "350km/h",
        acceleration: "2.9s",
        description: "The Sián Roadster combines Lamborghini's legendary V12 engine with hybrid technology, offering a unique open-top driving experience. With its futuristic design and innovative powertrain, the Sián Roadster represents the pinnacle of Lamborghini's engineering and performance.",
        price: "$3,700,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "260km/h",
        acceleration: "6.8s",
        description: "The Lamborghini Jarama GT is a classic grand tourer from the 1970s, featuring a 3.9-liter V12 engine and distinctive styling. Known for its luxurious interior and refined performance, the Jarama GT is a testament to Lamborghini's heritage of elegance and power.",
        price: "$350,000"
    },
    {
        brand: "Lamborghini",
        ...
        max_speed: "290km/h",
        acceleration: "6.7s",
        description: "The Miura P400 SV is an iconic supercar from the 1970s, often considered the first true supercar. With its mid-engine layout and stunning design, the Miura SV set new standards for performance and aesthetics in the automotive world.",
        price: "$3,000,000"
    },
    {
        brand: "Ferrari",
    ...
    },
    {
        ...
        max_speed: "320 km/h",
        acceleration: "3.45s",
        description: "The Ferrari Portofino M represents the evolution of the renowned Portofino, combining elegant design with exhilarating performance. With 620 CV generated by a turbocharged V8 engine, the Portofino M achieves a top speed of 320 km/h and accelerates from 0 to 100 km/h in just 3.45 seconds. This convertible GT is designed for both comfort and speed, offering a versatile driving experience that encompasses the thrill of Ferrari's performance capabilities and the luxury of open-top driving.",
        price: "$245,000"
    },
    {
        brand: "Ferrari",
    ...
    },
    {
        ...
        max_speed: "260km/h",
        acceleration: "2.8s",
        description: "The Porsche Taycan Turbo S represents the future of electric sports cars. With an all-electric powertrain, the Taycan Turbo S combines Porsche's legendary performance with cutting-edge technology. It features a dual-motor setup that produces 761 PS and can accelerate from 0 to 100 km/h in just 2.8 seconds. The Taycan Turbo S also boasts advanced driving dynamics and a luxurious interior, making it a perfect blend of innovation and tradition. The car's top speed is 260 km/h, and it offers an unparalleled driving experience, proving that electrification does not compromise the thrill of driving a Porsche.",
        price: "$185,000"
    },
    {
        brand: "Porsche",
